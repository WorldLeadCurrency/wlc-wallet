...
public final class Constants
{
	...
	public static final String REPORT_EMAIL = "support@winc-ev.org";;
	...
	public static final String SOURCE_URL = "https://github.com/Worldleadcurrency/" + CoinDefinition.coinName.toLowerCase() + "-wallet";
	public static final String BINARY_URL = "https://github.com/Worldleadcurrency/"+ CoinDefinition.coinName.toLowerCase() +"-wallet/releases";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/Worldleadcurrency/" + CoinDefinition.coinName.toLowerCase() + "j";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
    public static final String CREDITS_WEBSITE_URL = "http://www.winc-ev.org/";
    public static final String CREDITS_FORUM_URL = "https://bitcointalk.org/index.php?topic=791398.0/";

	public static final String CREDITS_ICON_URL = "https://bitcointalk.org/index.php?action=profile;u=2062";

	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/Rik8119";
